...
Pod::Spec.new do |s|
  s.name             = 'PodTestProj'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PodTestProj.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/PodTestProj'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Harsh Jaiswal' => 'harsh.jaiswal@actolap.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/PodTestProj.git', :tag => s.version.to_s }
